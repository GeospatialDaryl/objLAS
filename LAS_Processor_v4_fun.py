def LASProcessor4():
    ...
    workPaths.lasworkspace = thisOperationPath+"LAS\\" #this needed toggling back from LAS_b 12/22/2011
    ...
    for LASObjs in listLASObj:
        ...
        #LASObjs.makeMetrics(workPaths,9.,["cover"])import ClassLASObj_v13
    from ClassLASObj_v13 import *
    #Class LTKPaths contains Machine Specific Paths
    import ModuleLiDARtools_v1
    from ModuleLiDARtools_v1 import * #Paths
